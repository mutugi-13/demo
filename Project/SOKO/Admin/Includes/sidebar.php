...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="../index.php">
        <span class="ms-1 font-weight-bold text-white"><i>SOKO E-COMMERCE</i></span>
      </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a class="nav-link text-white <?= $page == "../pages/dashboard.html"? 'active bg-gradient-primary':''; ?>" href="index.php">
        ...
        <li class="nav-item">
          <a class="nav-link text-light <?= $page == "category.php"? 'active bg-gradient-success':''; ?>" href="category.php">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
