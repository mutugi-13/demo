    ...
    <div class="col-md-12">
        ...
        <div class="card">
            ...
            <div class="card-body">
                    ...
                    <textarea rows="3" name="meta_description" placeholder="Enter description" class="form-control"><?= $data['meta_description'] ?> </textarea></div>
                    <div class="col-md-12">
                    <label for="">Meta Keywords</label>
                    <textarea rows="3" name="meta_keywords" placeholder="Enter meta keywords" class="form-control"><?= $data['meta_keywords'] ?></textarea></div>
                    <div class="col-md-6">
